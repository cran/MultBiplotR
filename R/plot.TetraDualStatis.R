plot.TetraDualStatis <- function(x, A1 = 1, A2 = 2, PlotType="InterStructure", PlotRowTraj=FALSE, 
                                 PlotVarTraj=FALSE, LabelTraj='Begining', VarColorType="Biplot", 
                                 VarColors=NULL, VarLabels=NULL, RowColors=NULL, TableColors=NULL, 
                                 RowRandomColors=FALSE, TypeTraj="line", ...) {
  
  PlotTypes=c("Biplot", "Compromise", "Correlations", "Contributions", "InterStructure")
  ...
  if (PlotType=="Biplot")
    plot(x$Biplot, A1=A1, A2=A2, ColorVar=ColorVar, VarLabels=VarLabels, ColorInd=x$Biplot$RowColors, ...)
